...
/obj/structure/window/reinforced
	...
	armor = list(MELEE = 65, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 25, BIO = 100, RAD = 100, FIRE = 80, ACID = 100)
	max_integrity = 75
	explosion_block = 1
...
/obj/structure/window/attackby_secondary(obj/item/tool, mob/user, params)
	if(!reinf)
		return
	switch(state)
		if(RWINDOW_SECURE)
