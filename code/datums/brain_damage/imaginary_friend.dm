...
/mob/camera/imaginary_friend/proc/setup_friend()
	...
	name = real_name
	human_image = get_flat_human_icon(null, pick(SSjob.main_jobs.joinable_occupations))
...
/mob/camera/imaginary_friend/proc/friend_talk(message)
	...
	var/rendered = SPAN("game say", "[SPAN_NAME("[name]")] [SPAN("message", "[say_quote(message)]")]")
	var/dead_rendered = SPAN("game say", "[SPAN_NAME("[name] (Imaginary friend of [owner])")] [SPAN("message", "[say_quote(message)]")]")
